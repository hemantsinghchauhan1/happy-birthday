...
export default function BottomAudioDock({ activeCardId, onToggleAudio, onStopAudio, onOpenModal }) {
  ...
  return (
    <div
      className="fixed left-1/2 bottom-3 sm:bottom-4 z-50 -translate-x-1/2 w-[92%] max-w-xl pointer-events-auto"
      style={{
    ...
    >
      <div className="relative flex items-center justify-between gap-2 sm:gap-4 rounded-2xl sm:rounded-3xl bg-[#0b0b14]/95 p-2 sm:p-3 px-3 sm:px-4 text-white backdrop-blur-2xl border border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.9)]">
        ...
        >
          ...
          <div className="text-left overflow-hidden">
            ...
            <h4 className="text-[11px] sm:text-sm font-bold text-white truncate max-w-[100px] xs:max-w-[140px] sm:max-w-[240px]">
              {currentItem.songTitle}
            </h4>
            <p className="text-[9px] sm:text-xs text-white/60 truncate max-w-[100px] xs:max-w-[140px] sm:max-w-[240px]">
        ...
        <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
          ...
          <button
            ...
            className={`flex h-8 sm:h-11 px-2.5 sm:px-4 items-center gap-1 rounded-full font-bold text-[11px] sm:text-xs transition shadow-lg ${
              isPlaying
